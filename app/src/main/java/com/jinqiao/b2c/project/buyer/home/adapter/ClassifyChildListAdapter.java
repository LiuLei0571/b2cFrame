...
public class ClassifyChildListAdapter extends BaseExpandableListAdapter {
	...
	public ClassifyChildListAdapter(Context view, int myPaddingLeft,
	...
	public ClassifyChildListAdapter(int myPaddingLeft,
