...
import com.jinqiao.b2c.common.ui.TypeParse;
    ...
    protected void showTitle(TemplateTitleBaseHolder holder, ModelPage forum) {
        ...
        if (forum.isTitleVisible()) {
            ...
            if ("TITLE_IMAGE".equals(forum.getTitleType())) {
                ...
                ImageHelper.display(bgImg, forum.getTitleImage());
            } else {
                //文字样式
                ...
                UIHelper.showHtmlContent(holder.title, forum.getTitleText());
                if (!TextUtils.isEmpty(forum.getTitleIcon())) {
                    holder.leftImg.setVisibility(View.VISIBLE);
                    ImageHelper.display(holder.leftImg, forum.getTitleIcon());
                } else {
...
//                }
                ...
                ImageHelper.display(bgImg, forum.getBannerImage());
