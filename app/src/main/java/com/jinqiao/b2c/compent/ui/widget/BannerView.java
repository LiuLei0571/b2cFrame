...
import com.jinqiao.b2c.compent.base.BaseRelativeLayout;
...
import com.jinqiao.b2c.project.buyer.home.manager.bean.BannerAdDetail;
    ...
    protected void onFinishInflate() {
        ...
        mViewPager.setAdapter(new PagerAdapter() {
            ...
            public Object instantiateItem(ViewGroup container, final int position) {
                ...
                mImageLoader.displayImage(Configs.IMAGE_URL + modele.getPicPath(), imageView,options);
